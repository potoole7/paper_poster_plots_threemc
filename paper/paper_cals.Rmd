...
(
`n_required_vmmc %>% filter(age_group == "10-29") %>% pull(lower_diff)`
 to 
`n_required_vmmc %>% filter(age_group == "10-29") %>% pull(upper_diff)`
)
and 
`n_required_vmmc %>% filter(age_group == "15-49") %>% pull(mean_diff)`
(
`n_required_vmmc %>% filter(age_group == "15-49") %>% pull(mean_diff)`
to
`n_required_vmmc %>% filter(age_group == "15-") %>% pull(mean_diff)`
)
