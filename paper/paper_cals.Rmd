...
(
`r max_min_cov %>% filter(type == "MC") %>% slice(2) %>% pull(lower) %>% to_percentage()`
-
...
(
`r max_min_cov %>% filter(type == "MC") %>% slice(1) %>% pull(lower) %>% to_percentage()`
-
...
(
`r max_min_cov %>% filter(type == "MMC") %>% slice(2) %>% pull(lower) %>% to_percentage()`
-
...
(
`r max_min_cov %>% filter(type == "MMC") %>% slice(1) %>% pull(lower) %>% to_percentage()`
-
...
(
`r max_min_cov %>% filter(type == "TMC") %>% slice(2) %>% pull(lower) %>% to_percentage()`
-
...
(
`r max_min_cov %>% filter(type == "TMC") %>% slice(1) %>% pull(lower) %>% to_percentage()`
-
...
(
`r max_min_within_cntry_diff %>% filter(type == "MC") %>% slice(1) %>% pull(mean) %>% to_percentage()` 
to 
...
(`r max_min_within_cntry_diff %>% filter(type == "MC") %>% slice(3) %>% pull(mean) %>% to_percentage()` 
to 
