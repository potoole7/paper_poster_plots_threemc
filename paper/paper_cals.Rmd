...
`r max_min_cov %>% filter(type == "MC") %>% slice(2) %>% pull(mean) %>% to_percentage()`
(
`r max_min_cov %>% filter(type == "MC") %>% slice(2) %>% pull(lower)`
-
`r max_min_cov %>% filter(type == "MC") %>% slice(2) %>% pull(upper) %>% to_percentage()`
) in 
`r max_min_cov %>% filter(type == "MC") %>% slice(2) %>% pull(iso3) %>% to_cntry_name()`
to 
`r max_min_cov %>% filter(type == "MC") %>% slice(1) %>% pull(mean) %>% to_percentage()`
(
`r max_min_cov %>% filter(type == "MC") %>% slice(1) %>% pull(lower)`
-
`r max_min_cov %>% filter(type == "MC") %>% slice(1) %>% pull(upper) %>% to_percentage()`
) in 
`r max_min_cov %>% filter(type == "MC") %>% slice(1) %>% pull(iso3) %>% to_cntry_name()`.
MMC coverage ranged from 
`r max_min_cov %>% filter(type == "MMC") %>% slice(2) %>% pull(mean) %>% to_percentage()`
(
`r max_min_cov %>% filter(type == "MMC") %>% slice(2) %>% pull(lower)`
-
`r max_min_cov %>% filter(type == "MMC") %>% slice(2) %>% pull(upper) %>% to_percentage()`
) in 
`r max_min_cov %>% filter(type == "MMC") %>% slice(2) %>% pull(iso3) %>% to_cntry_name()`
to 
`r max_min_cov %>% filter(type == "MMC") %>% slice(1) %>% pull(mean) %>% to_percentage()`
(
`r max_min_cov %>% filter(type == "MMC") %>% slice(1) %>% pull(lower)`
-
`r max_min_cov %>% filter(type == "MMC") %>% slice(1) %>% pull(upper) %>% to_percentage()`
) in 
`r max_min_cov %>% filter(type == "MMC") %>% slice(1) %>% pull(iso3) %>% to_cntry_name()`.
, and TMC coverage
from 
`r max_min_cov %>% filter(type == "TMC") %>% slice(2) %>% pull(mean) %>% to_percentage()`
(
`r max_min_cov %>% filter(type == "TMC") %>% slice(2) %>% pull(lower)`
-
`r max_min_cov %>% filter(type == "TMC") %>% slice(2) %>% pull(upper) %>% to_percentage()`
) in 
`r max_min_cov %>% filter(type == "TMC") %>% slice(2) %>% pull(iso3) %>% to_cntry_name()`
to 
`r max_min_cov %>% filter(type == "TMC") %>% slice(1) %>% pull(mean) %>% to_percentage()`
(
`r max_min_cov %>% filter(type == "TMC") %>% slice(1) %>% pull(lower)`
-
`r max_min_cov %>% filter(type == "TMC") %>% slice(1) %>% pull(upper) %>% to_percentage()`
) in 
...
Lesotho from 
`r max_min_increase %>% filter(type == "MMC") %>% slice(1) %>% pull(mean_2006) %>% to_percentage()`
to 
`r max_min_increase %>% filter(type == "MMC") %>% slice(1) %>% pull(mean_2020) %>% to_percentage()`.
Within countries, the median difference in MC coverage between the districts with lowest and highest coverage was 
`r median_district_diff %>% filter(type == "MC") %>% pull(mean_diffs) %>% to_percentage()`
with the smallest variation in 
`r max_min_within_cntry_diff %>% filter(type == "MC") %>% slice(1) %>% pull(iso3) %>% to_cntry_name()`
(
`r max_min_within_cntry_diff %>% filter(type == "MC") %>% slice(1) %>% pull(mean)` 
-
`r max_min_within_cntry_diff %>% filter(type == "MC") %>% slice(2) %>% pull(mean) %>% to_percentage()` 
) and largest in 
`r max_min_within_cntry_diff %>% filter(type == "MC") %>% slice(3) %>% pull(iso3) %>% to_cntry_name()`
(`r max_min_within_cntry_diff %>% filter(type == "MC") %>% slice(3) %>% pull(mean)` 
-
`r max_min_within_cntry_diff %>% filter(type == "MC") %>% slice(4) %>% pull(mean) %>% to_percentage()`).
...
`r x0$n_subnat_areas`
subnational areas amongst these countries were included in these surveys.
Of these 
`r x0$n_surveys_orig`
surveys, 
`r x0$n_surveys`
contained sufficient information on circumcision, as outlined in section 
\ref{sec:org020fc8c}.
...
The disparity between the number of MCs performed and the number of MMCs performed can be partially attributed to the fact that for five countries, Liberia, Senegal, Niger, Guinea and the Democratic Republic of the Congo, we have no circumcision type information, and so can only estimate MC, not MMC or TMC.
...
(`r covs[[2]] %>% filter(type == "MC") %>% pull(lower)` 
- 
...
(`r covs[[2]] %>% filter(type == "MMC") %>% pull(lower)` 
- 
...
(`r iso3_lowest_highest_cov %>% filter(type == "MC", year == 2006) %>% slice(2) %>% pull(lower)`
- 
...
(`r iso3_lowest_highest_cov %>% filter(type == "MC", year == 2006) %>% slice(1) %>% pull(lower)`
- 
...
(`r iso3_lowest_highest_cov %>% filter(type == "MMC", year == 2006) %>% slice(2) %>% pull(lower)`
- 
...
(`r iso3_lowest_highest_cov %>% filter(type == "MMC", year == 2006) %>% slice(1) %>% pull(lower)`
- 
...
(`r iso3_lowest_highest_cov %>% filter(type == "TMC", year == 2006) %>% slice(2) %>% pull(lower)`
- 
...
(`r iso3_lowest_highest_cov %>% filter(type == "TMC", year == 2006) %>% slice(1) %>% pull(lower)`
- 
...
(`r iso3_lowest_highest_cov %>% filter(type == "MC", year == 2020) %>% slice(2) %>% pull(lower)`
- 
...
(`r iso3_lowest_highest_cov %>% filter(type == "MC", year == 2020) %>% slice(1) %>% pull(lower)`
- 
...
(`r iso3_lowest_highest_cov %>% filter(type == "MMC", year == 2020) %>% slice(2) %>% pull(lower)`
- 
...
to
`r iso3_lowest_highest_cov %>% filter(type == "MMC", year == 2020) %>% slice(1) %>% pull(mean)`
(`r iso3_lowest_highest_cov %>% filter(type == "MMC", year == 2020) %>% slice(1) %>% pull(lower) %>% to_percentage()`
- 
(`r iso3_lowest_highest_cov %>% filter(type == "MMC", year == 2020) %>% slice(1) %>% pull(upper)`)
in 
...
(`r iso3_lowest_highest_cov %>% filter(type == "TMC", year == 2020) %>% slice(2) %>% pull(lower)`
- 
...
(`r iso3_lowest_highest_cov %>% filter(type == "TMC", year == 2020) %>% slice(1) %>% pull(lower)`
- 
...
(`r iso3_cov_diffs %>% filter(type == "MC") %>% slice(1) %>% pull(lower)`
-
...
(`r iso3_cov_2006_2020 %>% filter(type == "MC", year == 2006) %>% pull(lower)`
-
...
(`r iso3_cov_2006_2020 %>% filter(type == "MC", year == 2020) %>% pull(lower)`
-
...
(`r iso3_cov_diffs %>% filter(type == "MMC") %>% slice(1) %>% pull(lower)`
-
...
(`r iso3_cov_2006_2020 %>% filter(type == "MMC", year == 2006) %>% pull(lower)`
-
...
(`r iso3_cov_2006_2020 %>% filter(type == "MMC", year == 2020) %>% pull(lower)`
-
...
(`r iso3_cov_diffs %>% filter(type == "TMC") %>% slice(1) %>% pull(upper)`
-
...
(`r iso3_cov_2006_2020 %>% filter(type == "TMC", year == 2006) %>% pull(lower)`
-
`r iso3_cov_2006_2020 %>% filter(type == "TMC", year == 2006) %>% pull(upper) %>% to_percentage()`)
in 2006 to 
`r iso3_cov_2006_2020 %>% filter(type == "TMC", year == 2020) %>% pull(mean)`
(`r iso3_cov_2006_2020 %>% filter(type == "TMC", year == 2020) %>% pull(lower)`
-
...
(
`r age_group_cov$fyag_highest_covs %>% filter(type == "MC", year == 2006) %>% pull(lower)`
-
...
(
`r age_group_cov$fyag_highest_covs %>% filter(type == "MC", year == 2020) %>% pull(lower)`
-
...
(
`r age_group_cov$fyag_highest_covs %>% filter(type == "MMC", year == 2006) %>% pull(lower)`
-
...
(
`r age_group_cov$fyag_highest_covs %>% filter(type == "MMC", year == 2020) %>% pull(lower)`
-
...
(
`r age_group_cov$fyag_highest_covs %>% filter(type == "TMC", year == 2006) %>% pull(lower)`
-
...
(
`r age_group_cov$fyag_highest_covs %>% filter(type == "TMC", year == 2020) %>% pull(lower)`
-
...
(
`r age_group_cov$spec_agegroups_mean_cov %>% filter(type == "MC", age_group == "15-29", year == 2006) %>% pull(lower)`
- 
...
(
`r age_group_cov$spec_agegroups_mean_cov %>% filter(type == "MC", age_group == "15-29", year == 2020) %>% pull(lower)`
- 
...
(
`r age_group_cov$spec_agegroups_mean_cov %>% filter(type == "MC", age_group == "30-49", year == 2006) %>% pull(lower)`
- 
...
(
`r age_group_cov$spec_agegroups_mean_cov %>% filter(type == "MC", age_group == "30-49", year == 2020) %>% pull(lower)`
- 
...
(
`r age_group_cov$spec_agegroups_mean_cov %>% filter(type == "MMC", age_group == "15-29", year == 2006) %>% pull(lower)`
- 
...
(
`r age_group_cov$spec_agegroups_mean_cov %>% filter(type == "MMC", age_group == "15-29", year == 2020) %>% pull(lower)`
- 
...
(
`r age_group_cov$spec_agegroups_mean_cov %>% filter(type == "MMC", age_group == "30-49", year == 2006) %>% pull(lower)`
- 
...
(
`r age_group_cov$spec_agegroups_mean_cov %>% filter(type == "MMC", age_group == "30-49", year == 2020) %>% pull(lower)`
- 
...
(
`r age_group_cov$spec_agegroups_mean_cov %>% filter(type == "TMC", age_group == "15-29", year == 2006) %>% pull(lower)`
- 
...
(
`r age_group_cov$spec_agegroups_mean_cov %>% filter(type == "TMC", age_group == "15-29", year == 2020) %>% pull(lower)`
- 
...
(
`r age_group_cov$spec_agegroups_mean_cov %>% filter(type == "TMC", age_group == "30-49", year == 2006) %>% pull(lower)`
- 
...
(
`r age_group_cov$spec_agegroups_mean_cov %>% filter(type == "TMC", age_group == "30-49", year == 2020) %>% pull(lower)`
- 
...
(
`r age_group_cov_vmmc$fyag_highest_covs %>% filter(year == 2006, type == "MC") %>% pull(lower)`
 - 
...
(
`r age_group_cov_vmmc$fyag_highest_covs %>% filter(year == 2020, type == "MC") %>% pull(lower)`
 - 
...
`r age_group_cov_vmmc$fyag_highest_covs %>% filter(year == 2006, type == "MMC") %>% pull(mean) %>% to_percentage()`
 (
`r age_group_cov_vmmc$fyag_highest_covs %>% filter(year == 2006, type == "MMC") %>% pull(lower)`
 - 
...
`r age_group_cov_vmmc$fyag_highest_covs %>% filter(year == 2020, type == "MMC") %>% pull(mean) %>% to_percentage()`
 (
`r age_group_cov_vmmc$fyag_highest_covs %>% filter(year == 2020, type == "MMC") %>% pull(lower)`
 - 
...
`r age_group_cov_vmmc$fyag_highest_covs %>% filter(year == 2006, type == "TMC") %>% pull(mean) %>% to_percentage()`
 (
`r age_group_cov_vmmc$fyag_highest_covs %>% filter(year == 2006, type == "TMC") %>% pull(lower)`
 - 
...
(
`r age_group_cov_non_vmmc$fyag_highest_covs %>% filter(year == 2006, type == "MC") %>% pull(lower)`
 - 
...
(
`r age_group_cov_non_vmmc$fyag_highest_covs %>% filter(year == 2020, type == "MC") %>% pull(lower)`
 - 
...
`r age_group_cov_non_vmmc$fyag_highest_covs %>% filter(year == 2006, type == "MMC") %>% pull(mean) %>% to_percentage()`
 (
`r age_group_cov_non_vmmc$fyag_highest_covs %>% filter(year == 2006, type == "MMC") %>% pull(lower)`
 - 
...
`r age_group_cov_non_vmmc$fyag_highest_covs %>% filter(year == 2020, type == "MMC") %>% pull(mean) %>% to_percentage()`
 (
`r age_group_cov_non_vmmc$fyag_highest_covs %>% filter(year == 2020, type == "MMC") %>% pull(lower)`
 - 
...
`r age_group_cov_non_vmmc$fyag_highest_covs %>% filter(year == 2006, type == "TMC") %>% pull(mean) %>% to_percentage()`
 (
`r age_group_cov_non_vmmc$fyag_highest_covs %>% filter(year == 2006, type == "TMC") %>% pull(lower)`
 - 
...
(
`r age_group_cov_vmmc$spec_agegroups_mean_cov %>% filter(type == "MC", age_group == "15-29", year == 2006) %>% pull(lower)`
- 
...
(
`r age_group_cov_vmmc$spec_agegroups_mean_cov %>% filter(type == "MC", age_group == "15-29", year == 2020) %>% pull(lower)`
- 
...
(
`r age_group_cov_vmmc$spec_agegroups_mean_cov %>% filter(type == "MC", age_group == "30-49", year == 2006) %>% pull(lower)`
- 
...
(
`r age_group_cov_vmmc$spec_agegroups_mean_cov %>% filter(type == "MC", age_group == "30-49", year == 2020) %>% pull(lower)`
- 
...
(
`r age_group_cov_vmmc$spec_agegroups_mean_cov %>% filter(type == "MMC", age_group == "15-29", year == 2006) %>% pull(lower)`
- 
...
(
`r age_group_cov_vmmc$spec_agegroups_mean_cov %>% filter(type == "MMC", age_group == "15-29", year == 2020) %>% pull(lower)`
- 
...
(
`r age_group_cov_vmmc$spec_agegroups_mean_cov %>% filter(type == "MMC", age_group == "30-49", year == 2006) %>% pull(lower)`
- 
...
(
`r age_group_cov_vmmc$spec_agegroups_mean_cov %>% filter(type == "MMC", age_group == "30-49", year == 2020) %>% pull(lower)`
- 
...
(
`r age_group_cov_vmmc$spec_agegroups_mean_cov %>% filter(type == "TMC", age_group == "15-29", year == 2006) %>% pull(lower)`
- 
...
(
`r age_group_cov_vmmc$spec_agegroups_mean_cov %>% filter(type == "TMC", age_group == "15-29", year == 2020) %>% pull(lower)`
- 
...
(
`r age_group_cov_vmmc$spec_agegroups_mean_cov %>% filter(type == "TMC", age_group == "30-49", year == 2006) %>% pull(lower)`
- 
...
(
`r age_group_cov_vmmc$spec_agegroups_mean_cov %>% filter(type == "TMC", age_group == "30-49", year == 2020) %>% pull(lower)`
- 
...
(
`r age_group_cov_non_vmmc$spec_agegroups_mean_cov %>% filter(type == "MC", age_group == "15-29", year == 2006) %>% pull(lower)`
- 
...
(
`r age_group_cov_non_vmmc$spec_agegroups_mean_cov %>% filter(type == "MC", age_group == "15-29", year == 2020) %>% pull(lower)`
- 
...
(
`r age_group_cov_non_vmmc$spec_agegroups_mean_cov %>% filter(type == "MC", age_group == "30-49", year == 2006) %>% pull(lower)`
- 
...
(
`r age_group_cov_non_vmmc$spec_agegroups_mean_cov %>% filter(type == "MC", age_group == "30-49", year == 2020) %>% pull(lower)` 
- 
...
(
`r age_group_cov_non_vmmc$spec_agegroups_mean_cov %>% filter(type == "MMC", age_group == "15-29", year == 2006) %>% pull(lower)`
- 
...
(
`r age_group_cov_non_vmmc$spec_agegroups_mean_cov %>% filter(type == "MMC", age_group == "15-29", year == 2020) %>% pull(lower)`
- 
...
(
`r age_group_cov_non_vmmc$spec_agegroups_mean_cov %>% filter(type == "MMC", age_group == "30-49", year == 2006) %>% pull(lower)`
- 
...
(
`r age_group_cov_non_vmmc$spec_agegroups_mean_cov %>% filter(type == "MMC", age_group == "30-49", year == 2020) %>% pull(lower)`
- 
...
(
`r age_group_cov_non_vmmc$spec_agegroups_mean_cov %>% filter(type == "TMC", age_group == "15-29", year == 2006) %>% pull(lower)`
- 
...
(
`r age_group_cov_non_vmmc$spec_agegroups_mean_cov %>% filter(type == "TMC", age_group == "15-29", year == 2020) %>% pull(lower)`
- 
...
(
`r age_group_cov_non_vmmc$spec_agegroups_mean_cov %>% filter(type == "TMC", age_group == "30-49", year == 2006) %>% pull(lower)`
- 
...
(
`r age_group_cov_non_vmmc$spec_agegroups_mean_cov %>% filter(type == "TMC", age_group == "30-49", year == 2020) %>% pull(lower)`
- 
...
(
`r tmc_cov$mean_tmc_cov %>% filter(year == 2006) %>% pull(lower)`
to 
...
(
`r tmc_cov$mean_tmc_cov %>% filter(year == 2020) %>% pull(lower)`
to 
...
(
`r tmc_cov_non_vmmc$mean_tmc_cov %>% filter(year == 2006) %>% pull(lower)`
to 
...
(
`r tmc_cov_non_vmmc$mean_tmc_cov %>% filter(year == 2020) %>% pull(lower)`
to 
...
(
`r tmc_cov_vmmc$mean_tmc_cov %>% filter(year == 2006) %>% pull(lower)`
to 
...
(
`r tmc_cov_vmmc$mean_tmc_cov %>% filter(year == 2020) %>% pull(lower)`
to 
...
(
`r tmc_cov_ssa_15_29_30_49[[1]] %>% filter(year == 2006, age_group == "15-29") %>% pull(lower)`
to 
...
(
`r tmc_cov_ssa_15_29_30_49[[1]] %>% filter(year == 2020, age_group == "15-29") %>% pull(lower)`
to 
...
(
`r tmc_cov_ssa_15_29_30_49[[1]] %>% filter(year == 2006, age_group == "30-49") %>% pull(lower)`
to 
...
(
`r tmc_cov_ssa_15_29_30_49[[1]] %>% filter(year == 2020, age_group == "30-49") %>% pull(lower)`
to 
...
(
`r tmc_cov_non_vmmc_15_29_30_49[[1]] %>% filter(year == 2006, age_group == "15-29") %>% pull(lower)`
to 
...
(
`r tmc_cov_non_vmmc_15_29_30_49[[1]] %>% filter(year == 2020, age_group == "15-29") %>% pull(lower)`
to 
...
(
`r tmc_cov_non_vmmc_15_29_30_49[[1]] %>% filter(year == 2006, age_group == "30-49") %>% pull(lower)`
to 
...
(
`r tmc_cov_non_vmmc_15_29_30_49[[1]] %>% filter(year == 2020, age_group == "30-49") %>% pull(lower)`
to 
...
(
`r tmc_cov_vmmc_15_29_30_49[[1]] %>% filter(year == 2006, age_group == "15-29") %>% pull(lower)`
to 
...
(
`r tmc_cov_vmmc_15_29_30_49[[1]] %>% filter(year == 2020, age_group == "15-29") %>% pull(lower)`
to 
...
(
`r tmc_cov_vmmc_15_29_30_49[[1]] %>% filter(year == 2006, age_group == "30-49") %>% pull(lower)`
to 
...
(
`r tmc_cov_vmmc_15_29_30_49[[1]] %>% filter(year == 2020, age_group == "30-49") %>% pull(lower)`
to 
...
(
`r spec_country_tmc_decrease[[1]] %>% filter(year == 2006) %>% pull(lower)`
 to 
...
(
`r spec_country_tmc_decrease[[1]] %>% filter(year == 2020) %>% pull(lower)`
 to 
...
(
`r vmmc_cov_diff_10_29$mean_cov %>% filter(year == 2006, type == "MC") %>% pull(lower)`
to 
...
(
`r vmmc_cov_diff_10_29$mean_cov %>% filter(year == 2020, type == "MC") %>% pull(lower)`
to 
...
(
`r vmmc_cov_diff_10_29$cov_diff %>% filter(type == "MC") %>% pull(lower)`
- 
...
(
`r vmmc_cov_diff_10_29$mean_cov %>% filter(year == 2006, type == "MMC") %>% pull(lower)`
to 
...
(
`r vmmc_cov_diff_10_29$mean_cov %>% filter(year == 2020, type == "MMC") %>% pull(lower)`
- 
...
(
`r vmmc_cov_diff_10_29$cov_diff %>% filter(type == "MMC") %>% pull(lower)`
- 
...
(
`r vmmc_cov_diff_15_49$mean_cov %>% filter(year == 2006, type == "MC") %>% pull(lower)`
to 
...
(
`r vmmc_cov_diff_15_49$mean_cov %>% filter(year == 2020, type == "MC") %>% pull(lower)`
to 
...
(
`r vmmc_cov_diff_15_49$cov_diff %>% filter(type == "MC") %>% pull(lower)`
- 
...
(
`r vmmc_cov_diff_15_49$mean_cov %>% filter(year == 2006, type == "MMC") %>% pull(lower)`
to 
...
(
`r vmmc_cov_diff_15_49$mean_cov %>% filter(year == 2020, type == "MMC") %>% pull(lower)`
to 
...
(
`r vmmc_cov_diff_15_49$cov_diff %>% filter(type == "MMC") %>% pull(lower)`
- 
...
(
`r largest_smallest_vmmc %>% filter(year == 2020, type == "MC", age_group == "10-29") %>% slice(1) %>% pull(lower)`
-
...
(
`r largest_smallest_vmmc %>% filter(year == 2020, type == "MC", age_group == "10-29") %>% slice(n()) %>% pull(lower)`
-
...
(
`r largest_smallest_vmmc %>% filter(year == 2020, type == "MMC", age_group == "10-29") %>% slice(1) %>% pull(lower)`
-
...
(
`r largest_smallest_vmmc %>% filter(year == 2020, type == "MMC", age_group == "10-29") %>% slice(n()) %>% pull(lower)`
-
...
(
`r increase_vmmc %>% filter(type == "MC", age_group == "10-29") %>% slice(1) %>% pull(lower_2006)`
-
...
(
`r increase_vmmc %>% filter(type == "MC", age_group == "10-29") %>% slice(1) %>% pull(mean_2020)` 
-
`r increase_vmmc %>% filter(type == "MC", age_group == "10-29") %>% slice(1) %>% pull(mean_2020) %>% to_percentage()`
) in 2020, a 
`r increase_vmmc %>% filter(type == "MC", age_group == "10-29") %>% slice(1) %>% pull(diff_mean) %>% to_percentage()`
(
`r increase_vmmc %>% filter(type == "MC", age_group == "10-29") %>% slice(1) %>% pull(diff_lower)`
-
