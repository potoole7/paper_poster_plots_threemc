...
We can constrast this for the non-VMMC priority countries in SSA.
...
This indicates that MC has increased slightly in non-VMMC priority countries, but the age profile (in terms of the five-year age group with the highest coverage) hasn't noticably changed. 
...
Again, TMC coverage amongst both fifteen year age groups constrast to these increases for MC and MMC. 
TMC coverage amongst 15-29 year olds decreased from 
...
) in 2020, staying relatively stagnant. 
...
So the mean age at circumcision for MC and MMC went up slightly from 2006 to 2020. 
However, it is important to note that the uncertainty ranges in our credible intervals 
overlap, so this increase is ?. 
In constant, the mean age at circumcision for TMC decreased. 
...
- For SSA, MC and MMC age goes up, TMC goes down
