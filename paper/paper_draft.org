...
The survey weighted empirical survey circumcision coverages were compared to samples of 1000 draws from the posterior predictions of circumcision coverage for each country.
