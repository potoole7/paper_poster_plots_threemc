...
\begin{figure}[H]
    ...
    \caption{\emph{Absolute change in circumcision coverage between 2000 and 2020 for 15-29 year olds in all 33 sub-Saharan African countries, split by circumcision type. The countries below the horizontal black line are VMMC priority countries}}
\end{figure}
